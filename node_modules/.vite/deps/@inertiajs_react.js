  ...
  "node_modules/object-inspect/index.js"(exports, module) {
    ...
    module.exports = function inspect_(obj, options, depth, seen) {
      ...
      if (!isDate2(obj) && !isRegExp2(obj)) {
        ...
        var stringTag4 = !isPlainObject && toStringTag && Object(obj) === obj && toStringTag in obj ? $slice.call(toStr(obj), 8, -1) : protoTag ? "Object" : "";
        var constructorTag = isPlainObject || typeof obj.constructor !== "function" ? "" : obj.constructor.name ? obj.constructor.name + " " : "";
        var tag = constructorTag + (stringTag4 || protoTag ? "[" + $join.call($concat.call([], stringTag4 || [], protoTag || []), ": ") + "] " : "");
        if (ys.length === 0) {
          return tag + "{}";
        }
        if (indent) {
...
function baseInRange(number, start2, end) {
  return number >= nativeMin5(start2, end) && number < nativeMax7(start2, end);
}
...
function baseRange(start2, end, step, fromRight) {
  var index = -1, length = nativeMax11(nativeCeil4((end - start2) / (step || 1)), 0), result2 = Array(length);
  while (length--) {
...
function spread(func, start2) {
  ...
  start2 = start2 == null ? 0 : nativeMax12(toInteger_default(start2), 0);
  return baseRest_default(function(args) {
  ...
  while (++index < length) {
    ...
    switch (data.type) {
      ...
      case "take":
        ...
        break;
      case "takeRight":
        start2 = nativeMax14(start2, end - size2);
        break;
    }
  }
...
var WhenVisible = ({ children, data, params, buffer, as, always, fallback }) => {
  ...
  const pageProps = usePage().props;
  const keys = (0, import_react16.useMemo)(() => data ? Array.isArray(data) ? data : [data] : [], [data]);
  const [loaded, setLoaded] = (0, import_react16.useState)(() => keys.length > 0 && keys.every((key) => pageProps[key] !== void 0));
